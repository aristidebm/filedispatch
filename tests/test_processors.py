...
@pytest.mark.asyncio
@pytest.mark.process
async def test_local_storage_processor_acquire_the_file(mocker, config, filesystem):
...
@pytest.mark.asyncio
@pytest.mark.process
async def test_local_storage_processor_permissions_failure(mocker, config, filesystem):
...
@pytest.mark.asyncio
@pytest.mark.process
async def test_local_storage_processor_generated_payload(mocker, config, filesystem):
